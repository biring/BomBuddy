...
def main():
    try:
        ...
        menu_options = ['Scrub cBOM for cost walk',
                        'Scrub cBOM for stella database upload',
                        'Scrub eBOM for stella database upload']
        ...
        # run user selection
        if user_selection == 0:
            application.scrub_cbom_for_cost_walk()
        elif user_selection == 1:
            application.scrub_cbom_for_stella_db_upload()
        elif user_selection == 2:
            application.scrub_ebom_for_stella_db_upload()
        else:
